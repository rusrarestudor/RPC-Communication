...
public class ChartBaseline extends JFrame {

    ArrayList<Measurement> measurementsList;

    public ChartBaseline(ArrayList<Measurement> measurementsList) {
    ...
    private XYDataset createDataset() {
        ...
        XYSeries series1 = new XYSeries("Overall consumption");
    ...
    private JFreeChart createChart(final XYDataset dataset) {
        ...
        chart.setTitle(new TextTitle("Baseline",
